 ...
 * @author Aluno
 */
public class InsertSupplierController implements Initializable {
    ...
    private void setTexts() {
        ...
        buttonInsertSupplier.setText(Lang.get(buttonInsertSupplier.getText()));
    ...
    @FXML
    private void insertSupplierHandle(ActionEvent event) {
        try {
            ...
            if (isValid) {
                ...
                if (result.get() == ButtonType.YES) {
                    ...
                    Supplier supplier = new Supplier(false, companyCode, mnemonic, name, tax, taxType, annotation, image, address, contact);
    ...
    private Optional<ButtonType> showAlertSure() {
        Alert alertModify = new AlertCustom(Alert.AlertType.CONFIRMATION, Lang.get("Are you sure you want to insert supplier?"), ButtonType.YES, ButtonType.NO);
