...
public class InsertCustomerController implements Initializable {
    ...
    @FXML
    private Button buttonInsertCustomer;
    ...
    @FXML
    private void insertCustomerHandle(ActionEvent event) {
        ...
        try {
            ...
            if (isValid) {
                ...
                if (result.get() == ButtonType.YES) {
                    ...
                    Customer customer = new Customer(false, name, customerType, employee, tax, taxType, annotation, image, address, contact);
                    customer.insert();
    ...
    private void setTexts() {
        ...
        buttonInsertCustomer.setText(Lang.get(buttonInsertCustomer.getText()));
