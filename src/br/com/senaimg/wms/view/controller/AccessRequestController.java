 ...
 * @author Aluno
 */
public class AccessRequestController implements Initializable {
    ...
    private void setTexts() {
        ...
        buttonRequestAccess.setText(Lang.get(buttonRequestAccess.getText()));
    ...
    /*DIFERE*/
    @FXML
    private void resquestAccessHandle(ActionEvent event) {
        ...
        if (isValid) {
            ...
            if (result.get() == ButtonType.YES) {
                ...
                User newUser = new User(name, username, password, email, null, imageUser, birthDate, gender, phone, secQuestion, UserStatus.REQUESTED);
                newUser.insert();
    ...
    private Optional<ButtonType> showAlertSure() {
        Alert alertModify = new AlertCustom(Alert.AlertType.CONFIRMATION, Lang.get("Are you sure you want to request access?"), ButtonType.YES, ButtonType.NO);
